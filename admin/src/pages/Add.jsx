...
const Add = ({ token }) => {
   ...
   const [bestsallers, setBestsallers] = useState(false);
   ...
   const onSubmitHandler = async (e) => {
      ...
      try {
         const formData = new FormData(); // Corrected the case here
         formData.append("name", name);
         formData.append("price", price);
         formData.append("description", description);
         formData.append("category", category);
         formData.append("subcategory", subCategory);
         formData.append("bestseller", bestsallers);
   ...
   return (
      ...
      >
         ...
         <div className="flex gap-2 mt-2">
            <input
               onChange={() => setBestsallers((prev) => !prev)}
               checked={bestsallers}
               type="checkbox"
               id="bestsaller"
            />
            <label className="cursor-pointer" htmlFor="bestsaller">
               Add to bestsaller
            </label>
         </div>
