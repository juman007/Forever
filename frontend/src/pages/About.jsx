...
const About = () => {
   return (
      <div>
         <div className="text-2xl text-clip pt-8 border-t">
         ...
         <div className="my-10 flex flex-col md:flex-row gap-16">
            ...
            <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
               <p>
                  ...
                  easily discover, explore, and purchase a wide range of
                  products from the comfort of their homes.
               </p>
               <p>
                  ince our inception, we've worked tirelessly to curate a
